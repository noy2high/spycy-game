...
const cards = [
    ...
    "Lakukan gestur monyet setiap ingin bicara selama 3 ronde. Jika lupa, TENGGAK.",
    "TENGGAK tanpa menggunakan pergelangan tanganmu sama sekali.",
    ...
    "Pilih 2 orang. Mereka harus beradu panco. Yang kalah TENGGAK.",
    "Buat snapgram dengan muka ter-anehmu, hanya boleh dihapus saat ada yg like/reply.",
    "Tebak lagu yang sedang diputar. Gagal? TENGGAK.",
    "Lakukan 5 push-up atau TENGGAK.",
    "Tahan tawa dengan air di mulut bersama pemain terdekat, yang bocor duluan harus TENGGAK.",
    "Pilih 2 orang, lalu habiskan gelas mereka sekarang juga. TANPA ALASAN.",
    "Sebutkan semua Presiden Indonesia secara urut. Gagal? TENGGAK.",
    "Sesuai putaran, masing-masing pemain keluarkan suara binatang. Yang paling jelek TENGGAK.",
    "Yang terkahir berdiri dan angkat 1 kaki, harus TENGGAK semua gelas pemain lainnya.",
    "Sesuai putaran, lakukan satu gestur, pemain berikutnya harus menirui dan menambah gestur baru, lakukan terus sampai ada yang lupa atau mengulang. Yang kalah TENGGAK.",
    "Berdiri dan lakukan tarian robot selama 15 detik atau TENGGAK.",
    ...
    "Cium kaki pemain sebelah kirimu atau TENGGAK.",
    "Sebelum Rupiah, apa mata uang yang digunakan pada masa awal kemerdekaan Indonesia? Salah, TENGGAK.",
    "Abisin aja gelas lo sekarang, gausah cacicu.",
    "Tunjukan Bookmarks Twittermu kepada semua pemain, lalu TENGGAK.",
    "Telfon Mama Player sebelah kananmu, Gagal? TENGGAK 3x selama 3 putaran.",
    ...
    "Sesuai putaran, sebutkan nama-nama kota di Pulau Jawa. Yang mengulang atau gagal menjawab TENGGAK.",
    "Setiap berbicara, keluarkan suara babi pada akhiran kalimat selama 3 ronde. Jika lupa, TENGGAK.",
    "Selama 1 putaran, setiap kali ada yang menyebut namamu, kamu harus mendesah. Lupa? TENGGAK.",
    ...
    "Cium bibir sebelah kanan atau kirimu, Gagal? TENGGAK.",
    "Minum 5x. Lalu, berikan pelukan awkward selama 15 detik kepada lawan jenis di ruangan itu.",
    "Pemain di sebelah kirimu bebas memberi perintah padamu 1x dalam putaran ini.",
    "Pilih lagu di Spotify. Semuanya harus menyanyikan bait pertamanya. Yang paling diam TENGGAK.",
    "Lakukan handstand selama 10 detik. Jika gagal, TENGGAK.",
    "Spill it. Dimana tempat ter-absurd anda dan pasangan melakukan 'iclik'.",
    "Truth. Apa chat terakhir kamu ke mantan? Spill atau TENGGAK.",
    ...
    "Sebutkan dan jelaskan bagaimana first kiss-mu bisa terjadi. Malu? TENGGAK.",
    "Berikan semua minuman kepada orang yang paling kuat disini!",
    "Berikan HP anda kepada pemain sebelah kananmu dan biarkan dia melakukan apapun.",
    "PANGERAN! Pangku salah satu pemain lawan jenis dan minum setiap dia minum, lakukan selama 3 putaran.",
    "TUAN PUTRI! Pijat punggung salah satu pemain lawan jenis dan manjakan pemain tersebut selama 3 putaran.",
    "Jika baterai HPnya dibawah 50%, TENGGAK.",
    "Jika ada yang Hpnya di charge, maka dia berhak untuk TENGGAK.",
    "Yang memakai pakaian berwarna hitam, TENGGAK.",
    "SIAGA PERANG! Tiarap selama 3 ronde.",
    "Yang sedang merokok/vape/pods/dll, TENGGAK.",
    "Sebutkan 5 kata dengan awalan 'NG'. Gagal? TENGGAK.",
    "HIRARKI! Anda wajib menggunakan kalimat 'Siap' & 'Ndan' setiap berbicara kepada pemain lain layaknya tentara. Lupa? TENGGAK.",
    "Apa fantasi rahasia terbesarmu? Malu? TENGGAK.",
    "DINOSAURUS, Lakukan gaya T-Rex selama 2 ronde. Lupa? TENGGAK.",
    "Nyanyikan lagu 'MENGHENINGKAN CIPTA' dengan menghayati. Jika gagal TENGGAK.,",
